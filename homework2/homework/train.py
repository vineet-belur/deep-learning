    ...
    **kwargs,
    ...
    for epoch in range(num_epoch):
        ...
        for img, label in train_data:
            ...
            logger.add_scalar('train/accuracy', accuracy, global_step)
        ...
        if epoch_val_acc > 0.84:
            print(f"Early stopping at epoch {epoch + 1}, accuracy reached g.t. 0.84 {epoch_val_acc:.4f}")
            break
